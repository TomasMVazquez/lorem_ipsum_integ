          ...
          <div class="img-producto col-md-5">
            ...
            <div class="img-min">
             @foreach ($product->images as $prodImg)
               <!-- Large modal -->
            <button type="button" class="" data-toggle="modal" data-target=".bd-example-modal-lg{{$prodImg->id}}">
              <img src="/storage/items/{{$prodImg->route}}" alt="{{ $product->name }}" style="width:50px;">
            </button>

            <div class="modal fade bd-example-modal-lg{{$prodImg->id}}" tabindex="-1" role="dialog"
            aria-labelledby="myLargeModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <img src="/storage/items/{{$prodImg->route}}" alt="{{ $product->name }}" style="width:100%;">
                </div>
              </div>
            </div>
                  ...
                  <ul class="corazon">
                    <li style="width:20%">
                      <form id="theFavForm" method="post" style="margin:0;">
                        ...
                        <button class="btnHeart" type="submit">
                          @auth
                            @php
                              $var = true;
                            @endphp
